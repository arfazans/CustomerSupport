...
const Chatbot_Container = ({ onClose }) => {
  ...
  const handleSubmitMessageToBot = async () => {
    ...
    return (
      <div className="max-w-md mx-auto h-full bg-transparent shadow-md rounded-lg overflow-hidden">
        <div className="flex flex-col h-full pb-2.5">
          <div className="px-4 py-3 border-b dark:border-zinc-700">
            <div className="flex justify-between items-center">
              ...
              {/* cross button */}
              <div onClick={onClose} className="cursor-pointer hover:bg-gray-400 rounded">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
