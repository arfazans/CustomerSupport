...
function Navbar() {
  ...
  return (
    <header className="sticky max-sm:mx-4   top-4 inset-x-0 z-50 max-w-5xl w-full mx-auto rounded-4xl bg-gradient-to-tr from-neutral-700 to-neutral-600">
      <nav className="relative max-w-5xl w-full flex flex-wrap md:flex-nowrap items-center justify-between py-2 ps-5 pe-2 md:py-0">
        <div className="flex items-center">
          {/* Logo */}
          <a
            className="flex-none rounded-md lg:mr-60  text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80"
